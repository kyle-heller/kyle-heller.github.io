...
The other reason these courses matter is interviews. FAANG-tier companies will ask you to solve algorithm problems on a whiteboard or in a shared editor. You cannot pass those interviews without this knowledge. Whether that's a good way to hire is another question entirely. The reality is that if your career plan includes a Tier 1 company at any point, you need algorithms.
