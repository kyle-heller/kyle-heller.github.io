...
That's the job. It's not glamorous. It doesn't look impressive on a metrics dashboard. But that's how the team gets better without me being the bottleneck.
...
My job is to give each team what they need in the format they need it. That means writing one report that's simultaneously a customer-facing workaround, a developer-facing bug report, and a QA-facing test plan. You're basically writing three versions of the same problem for three different audiences at the same time.

Nobody warned me this would be the biggest part of the job. It is.

## Would I Do It Again?

Yes. The tech lead role taught me more about how teams actually work than anything else I've done. It also made it clear I want to build, not just fix. That's the next chapter.
