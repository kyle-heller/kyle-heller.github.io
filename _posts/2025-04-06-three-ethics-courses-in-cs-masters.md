...
I work in cloud infrastructure now. I'm not building recommendation algorithms or facial recognition systems. But the core lesson applies everywhere: the things we build get used in ways we didn't plan for, and we're usually the first people who could've spotted that.
...
The takeaway that stuck with me: the engineers building AI systems are making ethical decisions whether they realize it or not. Every training dataset is a value judgment. Every prompt template is a design choice about who the system serves. You can't really hide behind "I just build the infrastructure" when your infrastructure is what enables the harm.

## Do I Recommend It?

If your program offers ethics courses, take at least one. Not because it helps your resume. Nobody's hiring you for an ethics course. Take it because you'll start asking better questions before you build stuff. That ended up being worth more to me than another systems elective would've been.
